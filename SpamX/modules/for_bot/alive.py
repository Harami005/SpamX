...
async def SpamX_(SpamX: Client, message: Message):
    ...
    spamx_reply = "**__MADARA by ™°‌ 🇲​​​​​𝘼𝘿𝘼𝙍𝘼─⃛͢⋆ ⁪⁬⁮⁮⁮;__** \n\n"
    spamx_reply += "<=======================> \n"
    ...
    spamx_reply += f"**MADARA Version:** `{__version__}` \n"
    spamx_reply += f"**Python Version:** `{platform.python_version()}` \n"
    spamx_reply += f"**pyMADARA Version:** `{rizoelx_vr}` \n"
    ...
    spamx_reply += "<=======================> \n\n"
    spamx_reply += "**Source Code:** [GitHub 🐈‍⬛](https://github.com/MADARA1188/SpamX) \n\n"
    spamx_reply += "**© @MADARA1188** || Support: @MADARA_WORLD"
